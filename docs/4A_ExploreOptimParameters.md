...
See [Multiplex Optimization Process](OptimizationProcess.md) for details on simulated annealing optimization algorithm and parameters. 
...
![SAparams_TemperatureSchedule](assets/images/Default_TemperatureSchedule.png)
...
![SAparams_DimerAcceptanceByIteration](assets/images/Default_DimerAcceptanceByIteration.png)
